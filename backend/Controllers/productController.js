...
const {conn,productModel, userModel,ourProductModel,contactFormModel}=require('../config/db');
...
module.exports={getproductModel,insertProducts,getAll,upload,signupModel,loginModel,getOurProducts,getOurProductModel,createContactForm};