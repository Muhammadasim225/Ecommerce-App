...
{/* <SidebarCarousel  /> */}
  ...
  const [showModal , setShowModal] = useState(() => {
    // Check localStorage for the modal state
    const modalDismissed = localStorage.getItem('modalDismissed');
    
    return modalDismissed !== 'false';
  });
  useEffect(() => {
      ...
      <AnimatePresence mode="wait">
          ...
          <Routes location={location} key={location.key}>
            ...
            <Route path="/Home/About" element={ 
                <About setShowModel={setShowModal} onExitComplete={()=>{
      setShowModal(true)
    }} />} />
<Route
              path="/Home/Contact"
            ...
            <Route path="/account/product/:id" element={<motion.div
                ...
                ><Productdetail /></motion.div>} />
                 <Route path="/account/ourproduct/:id" element={<motion.div
                  ...
                  exit="exit"
                ><Productdetail /></motion.div>} />
            <Route path="/account/product/:id/cart" element={<motion.div
                  variants={contVariant}
                  initial="hidden"
                  animate="visible"
                  exit="exit"
                ><Cart /></motion.div>} />
                 <Route path="/cart" element={<motion.div
                  variants={contVariant}
                  initial="hidden"
                  animate="visible"
                  exit="exit"
                ><Cart /></motion.div>} />
            <Route path="/account/product/:id/cart/billingdetail" element={<motion.div
                  variants={contVariant}
                  initial="hidden"
                  animate="visible"
                  exit="exit"
