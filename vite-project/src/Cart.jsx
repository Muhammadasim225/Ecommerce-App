...
const Cart = () => {
    ...
    const nxtt = () => {
        navigate(`/account/product/${cart[0]?.id}/cart/billingdetail`);
    };
            ...
            <div className="container mx-auto px-10 py-20 font-custom">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                    ...
                    <div className="border border-gray-900 rounded-sm p-4">
                        ...
                        <button className="bg-red-500 text-white w-full py-2 mt-4 rounded" onClick={nxtt}>Proceed to checkout</button>
                    </div>
                </div>
            </div>
            <Footer />
